  ...
  return (
    <div className=" main-dashboard ">
      <div className="app-body">
        <div className="app-body-main-content p-6">
          <section className="service-section text-black">
            <h2>Service</h2>
          ...
          <section className="transfer-section text-black">
        ...
        <div className="app-body-sidebar p-6">
          <section className="payment-section text-black">
            <h2>New Payment</h2>
